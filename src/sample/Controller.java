...
public class Controller implements Initializable
{
    ...
    public void initialize(URL url, ResourceBundle resourceBundle)
    {
        ...
        media = new Media(new File("C:\\Users\\User\\Pictures\\Videos\\media.mp4").toURI().toString());
    ...
    {
        mediaPlayer.play();
        Image image = new Image(getClass().getResourceAsStream("/images/Pause.png"));
    ...
    {
        mediaPlayer.pause();
        Image image = new Image(getClass().getResourceAsStream("/images/Play.png"));
        playPauseBtn.setGraphic(new ImageView(image));
